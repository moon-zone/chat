...
let MessageController = class MessageController {
    ...
    addMessage(res, addMessage) {
        return this.messageService.addMessage(res, addMessage);
    }
};
__decorate([
    (0, common_1.Post)('getmsg'),
    __param(0, (0, common_1.Res)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, message_dto_1.GetMessageDto]),
    __metadata("design:returntype", Promise)
], MessageController.prototype, "getMessage", null);
__decorate([
    (0, common_1.Post)('addmsg'),
    __param(0, (0, common_1.Res)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, message_dto_1.AddMessageDto]),
    __metadata("design:returntype", Promise)
